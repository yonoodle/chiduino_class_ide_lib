...
void ServoTimer2::write(int value , int pulse_0, int pulse_180 )
{

if(value < 0) value = 0;
    if(value > 180) value = 180;
    value = map(value, 0, 180,  pulse_0,  pulse_180 );

   writeChan(this->chanIndex, value); // call the static function to store the data for this servo
}
